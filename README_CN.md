...
- **自定义 Provider Group 显示名** - 通过 label 字段在模型 picker 中显示自定义名称
...
- **丰富参数配置** - 支持 temperature、top_p、top_k、reasoning_effort 等参数
...
|------|--------|--------|----------|------|------|
| DeepSeek V4 Pro | DeepSeek 官方 | Yes | Yes | No | 已验证 |
| DeepSeek V4 Flash | DeepSeek 官方 | Yes | Yes | No | 已验证 |
| Mimo V2.5 Pro | 小米 | Yes | Yes | Yes | 已验证 |
