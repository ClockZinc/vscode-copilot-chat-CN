...
|------|------|
| 
ame | Group 名称（VS Code 自动生成或手动指定） |
| label | 自定义显示名，优先级：label > name > "CustomOAI" |
| endor | 固定为 "customoai" |
| piKey | API 密钥，支持 ${input:...} 变量 |
