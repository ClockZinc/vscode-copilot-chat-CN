...
export namespace ConfigKey {
	...
	*/
	...
	export namespace Deprecated {
		...
		export const CustomOAIModels = defineSetting<Record<string, { name: string; url: string; toolCalling: boolean; vision: boolean; maxInputTokens: number; maxOutputTokens: number; requiresAPIKey?: boolean; thinking?: boolean; adaptiveThinking?: boolean; supportsReasoningEffort?: string[]; streaming?: boolean; requestHeaders?: Record<string, string>; zeroDataRetentionEnabled?: boolean; includeReasoning?: boolean; temperature?: number; top_p?: number; top_k?: number }>>('chat.customOAIModels', ConfigType.Simple, {});
